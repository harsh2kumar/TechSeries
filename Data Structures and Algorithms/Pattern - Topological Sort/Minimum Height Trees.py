...
# The root (or the tree) with the minimum height will be called Minimum Height Tree (MHT). There can be multiple MHTs for a graph. In this problem, we need to find all
# those roots which give us MHTs. Write a method to find all MHTs of the given graph and return a list of their roots.
# Grokking https://www.educative.io/courses/grokking-the-coding-interview/7nDN8y7JKVA
# Leetcode https://leetcode.com/problems/minimum-height-trees/
# Solution https://leetcode.com/problems/minimum-height-trees/solution/
