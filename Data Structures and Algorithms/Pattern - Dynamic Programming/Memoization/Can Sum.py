...
class Solution:
    ...
    def canSum(self, targetSum: int, nums: List) -> bool:
...
sol = Solution()
print("7, [2, 3]: ", sol.canSum(7, [2, 3]))
sol = Solution()
print("7, [5, 3, 4, 7]: ", sol.canSum(7, [5, 3, 4, 7]))
sol = Solution()
print("7, [2, 4]: ", sol.canSum(7, [2, 4]))
sol = Solution()
print("8, [2, 3, 5]: ", sol.canSum(8, [2, 3, 5]))
sol = Solution()
print("300, [7, 14]: ", sol.canSum(300, [7, 14]))
