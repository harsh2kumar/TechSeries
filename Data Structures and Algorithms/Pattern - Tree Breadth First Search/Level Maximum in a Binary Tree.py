...
# Solution https://leetcode.com/problems/find-largest-value-in-each-tree-row/solution/
...
def find_level_maximum(root):
    ...
    while queue:
        ...
        for _ in range(level_size):
            ...
            current_level_max = max(current_node.val, current_level_max)
...
def main():
    ...
    print("Level maximum are: " + str(find_level_maximum(root)))
